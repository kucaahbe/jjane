class JjaneNodeGenerator < ScaffoldGenerator
  ...
  def initialize(runtime_args, runtime_options = {})
    ...
    runtime_args.insert 1, 'title:string', 'content:text', 'page_id:integer', 'user_id:integer'
    super
...
#      m.route_resources controller_file_name
      ...
      m.dependency 'migration', [name] + @args, :collision => :skip, :skip_fixture => true
